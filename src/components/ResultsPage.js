        ...
        <div className="col-lg-7 border-navy border-start-0 border-end-0" style={resultsStyle}>
            ...
            <div className='d-flex align-items-center justify-content-center' style={{height: "90%"}}>
                <ul className="list-group">
                    ...
                    <li className="list-group-item border-0 bg-tan text-center fw-bold h3">Total Profit: ${G.yearlyStateRecord.slice(1).reduce((partialSum, year) => partialSum + year.playerStats[playerID].Profit_Net, 0).toFixed(2)}</li>
                </ul>
            </div>
        </div>
    )
